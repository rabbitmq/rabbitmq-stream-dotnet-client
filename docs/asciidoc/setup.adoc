...
The previous command exposes stream port (5552), AMQP 0.9.1/ AMQP 1.0 (5672) and Management UI port (15672).
...
----
docker run -it --rm --name rabbitmq --network host rabbitmq:4
----
