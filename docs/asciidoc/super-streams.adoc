...
You can follow the README on the https://github.com/rabbitmq/rabbitmq-stream-dotnet-client/tree/documentation_website/docs/SuperStream[link] to run the Super Stream example with the single active consumer feature.
